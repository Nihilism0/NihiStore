...
service userService {
    ...
    common.NilResponse AddAmounrCart(1: AddAmountCartReq request) (api.post="/user/cart/addamountcart")
    common.NilResponse DeleteAmountCart(1: DeleteAmountCartReq request) (api.delete="/user/cart/deleteamountcart")
