...
service userService {
    ...
    common.NilResponse AddAmounrCart(1: AddAmountCartReq request) (api.update="/user/cart/addamountcart")
    common.NilResponse DeleteAmountCart(1: DeleteAmountCartReq request) (api.update="/user/cart/deleteamountcart")
